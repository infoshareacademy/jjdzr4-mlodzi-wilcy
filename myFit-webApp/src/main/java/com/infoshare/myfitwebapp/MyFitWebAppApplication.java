...
public class MyFitWebAppApplication {
    ...
    CommandLineRunner runner(UserService userService, ProductService productService){
        return args -> {
            ...
            TypeReference<List<UserData>> userDataTypeReference = new TypeReference<>(){};
            ...
            InputStream userDataInputStream = TypeReference.class.getClassLoader().getResourceAsStream("userData.json");
            try{
                ...
                List<UserData> usersData = mapper.readValue(userDataInputStream, userDataTypeReference);
